...
/obj/item/clothing/accessory/solgov/rank/oac/enlisted
	name = "ranks (E-1 junior trooper)"
	desc = "Insignia denoting the rank of Junior Trooper."
	icon_state = "marinerank_enlisted"

/obj/item/clothing/accessory/solgov/rank/oac/enlisted/e2
	name = "ranks (E-2 trooper)"
	desc = "Insignia denoting the rank of Trooper."
